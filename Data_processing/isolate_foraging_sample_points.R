## ---------------------------
##
## Script name: isolate_foraging_sample_points
##
## Purpose: Label GPS with behaviour, extract foraging components, sample available locations
##
## ---------------------------
##
## Inputs:
...
##
## Outputs:
##   - {species}_{colony}_HMM.RData
##   - {species}_{colony}_HMMdata.RData
##   - {species}_{colony}_labelledHMM.RData
...
packages <- c("dplyr", "magrittr", "ggplot2", "tidyr",
              "momentuHMM", "sf", "ecmwfr", "lubridate", "terra", "raster",
...
for (i in 1:length(spec_col)) {
  ...
  # Output
  save(all_pnts, file = paste0("Data_outputs/", spec_col[i], "_available_pnts_population_level.RData"))
