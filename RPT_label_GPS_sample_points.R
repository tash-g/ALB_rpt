...
for (i in 1:length(spec_col)) {
  ...
  if (colony_exp == "birdis" & my_species == "waal") {
    median_hatch <- "03-10" } else if (colony_exp == "birdis" & my_species == "bba") { 
      median_hatch <- "01-05" } else if (colony_exp == "crozet") {
        median_hatch <- "03-22" } else if (colony_exp == "kerguelen") {
          median_hatch <- "12-15" }
