...
This script is used to process GLS & GPS data for individual repeatability estimates. It subsets the GLS to the breeding season for later analysis, and produces the files used for the repeatability of foraging effort analyses.

**Inputs**:

-   species_colony_gls_labelled.RData

-   species_colony_gps_labelled.RData -\> CHECK WHERE THIS COMES FROM

**Outputs**:

-   species_colony_gls_labelled_subset*.*RData *-\> Used in processing in this script*

-   species_colony_individual_trips_summary.RData -\> *Used in analysis of foraging effort repeatability*
